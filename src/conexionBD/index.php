...
if(isset($_GET["insertar"])){
    ...
    $casoClinico=$data->casoClinico;
        if(($correo!="")&&($nombre!="")&&($edad!="")&&($sexo!="")&&($casoClinico!="")){
            
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(nombre,correo,edad,sexo,casoClinico) VALUES('$nombre','$correo','$edad','$sexo','$casoClinico') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET nombre='$nombre',correo='$correo',edad='$edad',sexo='$sexo',casoClinico='$casoClinico' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
